...
// Helper function to create mock lesson content
function createMockLessonContent(title: string): any {
  return {
    type: 'intro',
    stockyEmotion: 'happy',
    speechBubble: `Bienvenue à la leçon: ${title}!`,
    continueButtonText: "Commençons!"
  };
}

// Helper function to convert mock content to JSONB format
function mockContentToJSONB(content: any): any {
  return [content];
}
...
// Generate additional mock lessons for multiple chapters
export const mockLessonsData = [
  // CHAPTER 2 - Lecture des Graphiques (6 lessons)
  {
    module_id: 2,
    day_number: 3,
    lesson_number: 3.1,
    title: 'Introduction aux Graphiques en Ligne',
    description: 'Apprends les bases des graphiques linéaires',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Introduction aux Graphiques en Ligne')),
    min_score_to_pass: 70,
    xp_reward: 10,
    coin_reward: 5,
    is_locked: true,
    unlock_requirement: 'complete_module_1',
    estimated_duration_minutes: 5,
    level: 'beginner',
    order_index: 11
  },
  {
    ...
    day_number: 3,
    lesson_number: 3.2,
    title: 'Chandeliers Basiques',
    description: 'Comprends les bougies japonaises simples',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Chandeliers Basiques')),
    min_score_to_pass: 70,
    xp_reward: 10,
    coin_reward: 5,
    is_locked: true,
    unlock_requirement: 'complete_lesson_3.1',
    estimated_duration_minutes: 6,
    level: 'beginner',
    order_index: 12
  },
  {
    ...
    day_number: 3,
    lesson_number: 3.3,
    title: 'Patterns de Chandeliers Communs',
    description: 'Reconnais les patterns de bougies populaires',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Patterns de Chandeliers Communs')),
    min_score_to_pass: 70,
    xp_reward: 15,
    coin_reward: 10,
    is_locked: true,
    unlock_requirement: 'complete_lesson_3.2',
    estimated_duration_minutes: 7,
    level: 'intermediate',
    order_index: 13
  },
  {
    ...
    description: 'Découvre les graphiques en barres OHLC',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Graphiques en Barres')),
    min_score_to_pass: 70,
    xp_reward: 10,
    coin_reward: 5,
    is_locked: true,
    unlock_requirement: 'complete_lesson_3.3',
    estimated_duration_minutes: 6,
    level: 'beginner',
    order_index: 14
  },
  {
    ...
    description: 'Identifie les tendances haussières et baissières',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Analyse des Tendances')),
    min_score_to_pass: 70,
    xp_reward: 15,
    coin_reward: 10,
    is_locked: true,
    unlock_requirement: 'complete_lesson_4.1',
    estimated_duration_minutes: 7,
    level: 'intermediate',
    order_index: 15
  },
  {
    ...
    description: 'Trace et utilise les lignes de tendance',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Lignes de Tendance')),
    min_score_to_pass: 70,
    xp_reward: 20,
    coin_reward: 15,
    is_locked: true,
    unlock_requirement: 'complete_lesson_4.2',
    estimated_duration_minutes: 8,
    level: 'intermediate',
    order_index: 16
  },

  // CHAPTER 3 - Types d'Ordres (5 lessons)
  {
    module_id: 3,
    day_number: 5,
    lesson_number: 5.1,
    title: 'Ordres au Marché',
    description: 'Comprends les ordres market et leur utilisation',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Ordres au Marché')),
    min_score_to_pass: 70,
    xp_reward: 10,
    coin_reward: 5,
    is_locked: true,
    unlock_requirement: 'complete_module_2',
    estimated_duration_minutes: 5,
    level: 'beginner',
    order_index: 17
  },
  {
    ...
    day_number: 5,
    lesson_number: 5.2,
    title: 'Ordres Limités',
    description: 'Maîtrise les ordres limit pour contrôler les prix',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Ordres Limités')),
    min_score_to_pass: 70,
    xp_reward: 10,
    coin_reward: 5,
    is_locked: true,
    unlock_requirement: 'complete_lesson_5.1',
    estimated_duration_minutes: 6,
    level: 'beginner',
    order_index: 18
  },
  {
    ...
    description: 'Protège tes gains avec stop-loss et take-profit',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Stop-Loss et Take-Profit')),
    min_score_to_pass: 70,
    xp_reward: 15,
    coin_reward: 10,
    is_locked: true,
    unlock_requirement: 'complete_lesson_5.2',
    estimated_duration_minutes: 7,
    level: 'intermediate',
    order_index: 19
  },
  {
    ...
    day_number: 6,
    lesson_number: 6.1,
    title: 'Ordres Trailing Stop',
    description: 'Utilise les trailing stops pour maximiser les profits',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Ordres Trailing Stop')),
    min_score_to_pass: 70,
    xp_reward: 15,
    coin_reward: 10,
    is_locked: true,
    unlock_requirement: 'complete_lesson_5.3',
    estimated_duration_minutes: 7,
    level: 'intermediate',
    order_index: 20
  },
  {
    ...
    day_number: 6,
    lesson_number: 6.2,
    title: 'Stratégies d\'Ordres Avancées',
    description: 'Combine différents types d\'ordres efficacement',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Stratégies d\'Ordres Avancées')),
    min_score_to_pass: 70,
    xp_reward: 20,
    coin_reward: 15,
    is_locked: true,
    unlock_requirement: 'complete_lesson_6.1',
    estimated_duration_minutes: 8,
    level: 'intermediate',
    order_index: 21
  },

  // CHAPTER 4 - Support et Résistance (6 lessons)
  {
    module_id: 4,
    day_number: 7,
    lesson_number: 7.1,
    title: 'Identifier les Niveaux de Support',
    description: 'Apprends à trouver les zones de support',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Identifier les Niveaux de Support')),
    min_score_to_pass: 70,
    xp_reward: 10,
    coin_reward: 5,
    is_locked: true,
    unlock_requirement: 'complete_module_3',
    estimated_duration_minutes: 6,
    level: 'beginner',
    order_index: 22
  },
  {
    ...
    day_number: 7,
    lesson_number: 7.2,
    title: 'Identifier les Niveaux de Résistance',
    description: 'Détecte les zones de résistance sur les graphiques',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Identifier les Niveaux de Résistance')),
    min_score_to_pass: 70,
    xp_reward: 10,
    coin_reward: 5,
    is_locked: true,
    unlock_requirement: 'complete_lesson_7.1',
    estimated_duration_minutes: 6,
    level: 'beginner',
    order_index: 23
  },
  {
    ...
    day_number: 7,
    lesson_number: 7.3,
    title: 'Support et Résistance Psychologiques',
    description: 'Comprends les niveaux psychologiques importants',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Support et Résistance Psychologiques')),
    min_score_to_pass: 70,
    xp_reward: 15,
    coin_reward: 10,
    is_locked: true,
    unlock_requirement: 'complete_lesson_7.2',
    estimated_duration_minutes: 7,
    level: 'intermediate',
    order_index: 24
  },
  {
    ...
    day_number: 8,
    lesson_number: 8.1,
    title: 'Breakout et Breakdown',
    description: 'Reconnais les cassures de support/résistance',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Breakout et Breakdown')),
    min_score_to_pass: 70,
    xp_reward: 15,
    coin_reward: 10,
    is_locked: true,
    unlock_requirement: 'complete_lesson_7.3',
    estimated_duration_minutes: 7,
    level: 'intermediate',
    order_index: 25
  },
  {
    ...
    day_number: 8,
    lesson_number: 8.2,
    title: 'Retest des Niveaux',
    description: 'Confirme les niveaux avec des retests',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Retest des Niveaux')),
    min_score_to_pass: 70,
    xp_reward: 15,
    coin_reward: 10,
    is_locked: true,
    unlock_requirement: 'complete_lesson_8.1',
    estimated_duration_minutes: 7,
    level: 'intermediate',
    order_index: 26
  },
  {
    ...
    day_number: 8,
    lesson_number: 8.3,
    title: 'Trading avec Support/Résistance',
    description: 'Applique support/résistance dans tes trades',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Trading avec Support/Résistance')),
    min_score_to_pass: 70,
    xp_reward: 20,
    coin_reward: 15,
    is_locked: true,
    unlock_requirement: 'complete_lesson_8.2',
    estimated_duration_minutes: 8,
    level: 'intermediate',
    order_index: 27
  },

  // CHAPTER 5 - Gestion des Risques (5 lessons)
  {
    module_id: 5,
    day_number: 9,
    lesson_number: 9.1,
    title: 'Calculer le Risque par Trade',
    description: 'Détermine combien risquer par position',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Calculer le Risque par Trade')),
    min_score_to_pass: 70,
    xp_reward: 10,
    coin_reward: 5,
    is_locked: true,
    unlock_requirement: 'complete_module_4',
    estimated_duration_minutes: 6,
    level: 'beginner',
    order_index: 28
  },
  {
    ...
    description: 'Calcule des ratios R:R profitables',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Ratio Risque/Récompense')),
    min_score_to_pass: 70,
    xp_reward: 15,
    coin_reward: 10,
    is_locked: true,
    unlock_requirement: 'complete_lesson_9.1',
    estimated_duration_minutes: 7,
    level: 'intermediate',
    order_index: 29
  },
  {
    ...
    description: 'Détermine la taille optimale de tes positions',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Position Sizing')),
    min_score_to_pass: 70,
    xp_reward: 15,
    coin_reward: 10,
    is_locked: true,
    unlock_requirement: 'complete_lesson_9.2',
    estimated_duration_minutes: 7,
    level: 'intermediate',
    order_index: 30
  },
  {
    ...
    description: 'Répartis ton capital sur plusieurs positions',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Diversification du Portefeuille')),
    min_score_to_pass: 70,
    xp_reward: 15,
    coin_reward: 10,
    is_locked: true,
    unlock_requirement: 'complete_lesson_9.3',
    estimated_duration_minutes: 7,
    level: 'intermediate',
    order_index: 31
  },
  {
    ...
    description: 'Protège ton capital avec de bonnes pratiques',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Gestion du Capital')),
    min_score_to_pass: 70,
    xp_reward: 20,
    coin_reward: 15,
    is_locked: true,
    unlock_requirement: 'complete_lesson_10.1',
    estimated_duration_minutes: 8,
    level: 'intermediate',
    order_index: 32
  },

  // CHAPTER 6 - Patterns de Retournement (4 lessons)
  {
    module_id: 6,
    day_number: 11,
    lesson_number: 11.1,
    title: 'Head and Shoulders',
    description: 'Reconnais le pattern Head and Shoulders',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Head and Shoulders')),
    min_score_to_pass: 70,
    xp_reward: 15,
    coin_reward: 10,
    is_locked: true,
    unlock_requirement: 'complete_module_5',
    estimated_duration_minutes: 7,
    level: 'intermediate',
    order_index: 33
  },
  {
    ...
    day_number: 11,
    lesson_number: 11.2,
    title: 'Double Top et Double Bottom',
    description: 'Identifie les doubles sommets et doubles creux',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Double Top et Double Bottom')),
    min_score_to_pass: 70,
    xp_reward: 15,
    coin_reward: 10,
    is_locked: true,
    unlock_requirement: 'complete_lesson_11.1',
    estimated_duration_minutes: 7,
    level: 'intermediate',
    order_index: 34
  },
  {
    ...
    day_number: 12,
    lesson_number: 12.1,
    title: 'Triple Top et Triple Bottom',
    description: 'Détecte les triples sommets et triples creux',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Triple Top et Triple Bottom')),
    min_score_to_pass: 70,
    xp_reward: 15,
    coin_reward: 10,
    is_locked: true,
    unlock_requirement: 'complete_lesson_11.2',
    estimated_duration_minutes: 7,
    level: 'intermediate',
    order_index: 35
  },
  {
    ...
    day_number: 12,
    lesson_number: 12.2,
    title: 'Patterns de Retournement Avancés',
    description: 'Maîtrise les patterns complexes de retournement',
    lesson_type: 'mixed',
    content_json: mockContentToJSONB(createMockLessonContent('Patterns de Retournement Avancés')),
    min_score_to_pass: 70,
    xp_reward: 20,
    coin_reward: 15,
    is_locked: true,
    unlock_requirement: 'complete_lesson_12.1',
    estimated_duration_minutes: 8,
    level: 'advanced',
    order_index: 36
  },
...
// Combine all lessons
export const allLessonsData = [...lessons1to10Data, ...mockLessonsData];
